...
class EventDetailStated extends StatefulWidget {
  EventDetailStated(this._currentAccount, this.event, {Key? key})
      : super(key: key);
...
class _EventDetailState extends State<EventDetailStated> {
  @override
  EventDetailStated get widget => super.widget;
              ...
              header: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: NetworkImage(event.image), fit: BoxFit.fill)),
                  child: Column(
                                ...
                                Navigator.push(
                                  ...
                                  PageRouteBuilder(
                                    pageBuilder: (context, a1, a2) =>
                                        MainEvent(_currentUser),
                                    transitionsBuilder:
                                        (context, anim, a2, child) =>
                                            FadeTransition(
